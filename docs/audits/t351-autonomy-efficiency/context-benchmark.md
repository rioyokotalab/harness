...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| factual lookup | 73,734 | 1,639 | 97.7% | 2,906 | 1,412 | 51.4% |
| documentation edit | 73,545 | 1,816 | 97.5% | 2,717 | 1,589 | 41.5% |
| ordinary code fix | 74,455 | 1,636 | 97.8% | 3,627 | 1,409 | 61.1% |
| tmux health diagnosis | 73,545 | 1,613 | 97.8% | 2,717 | 1,386 | 48.9% |
| unsafe-tail recovery | 75,931 | 2,974 | 96.0% | 5,103 | 2,747 | 46.1% |
| fleet hardening | 76,238 | 4,282 | 94.3% | 5,410 | 4,055 | 25.0% |
| native HPC experiment | 77,550 | 3,222 | 95.8% | 6,722 | 2,995 | 55.4% |
| duration ledger | 80,599 | 1,917 | 97.6% | 9,771 | 1,690 | 82.7% |
...
reduction is 50.1%, above the 30% independent policy/skill threshold. The
always-read policy is 735 words, and the active board is 50 lines / 227 words,
...
50 lines / 227 words, so board plus representative payload is 653 words—43.3%

...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| factual lookup | 73,734 | 1,786 | 97.5% | 2,906 | 1,501 | 48.3% |
| documentation edit | 73,545 | 2,098 | 97.1% | 2,717 | 1,813 | 33.2% |
| ordinary code fix | 74,455 | 1,824 | 97.5% | 3,627 | 1,539 | 57.5% |
| tmux health diagnosis | 73,545 | 1,785 | 97.5% | 2,717 | 1,500 | 44.7% |
| unsafe-tail recovery | 75,931 | 3,144 | 95.8% | 5,103 | 2,859 | 43.9% |
| fleet hardening | 76,238 | 4,644 | 93.9% | 5,410 | 4,359 | 19.4% |
| native HPC experiment | 77,550 | 3,410 | 95.6% | 6,722 | 3,125 | 53.5% |
| duration ledger | 80,599 | 2,105 | 97.3% | 9,771 | 1,820 | 81.3% |
...
reduction is 46.5%, above the 30% independent policy/skill threshold. The
always-read policy is 824 words, and the active board is 69 lines / 358 words,
...
52 lines / 285 words, so board plus representative payload is 711 words—38.3%

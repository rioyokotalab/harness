...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| factual lookup | 73,734 | 1,685 | 97.7% | 2,906 | 1,429 | 50.8% |
| documentation edit | 73,545 | 1,862 | 97.4% | 2,717 | 1,606 | 40.8% |
| ordinary code fix | 74,455 | 1,682 | 97.7% | 3,627 | 1,426 | 60.6% |
| tmux health diagnosis | 73,545 | 1,659 | 97.7% | 2,717 | 1,403 | 48.3% |
| unsafe-tail recovery | 75,931 | 3,020 | 96.0% | 5,103 | 2,764 | 45.8% |
| fleet hardening | 76,238 | 4,328 | 94.3% | 5,410 | 4,072 | 24.7% |
| native HPC experiment | 77,550 | 3,268 | 95.7% | 6,722 | 3,012 | 55.1% |
| duration ledger | 80,599 | 1,963 | 97.5% | 9,771 | 1,707 | 82.5% |
...
always-read policy is 752 words, and the active board is 56 lines / 256 words,
...
56 lines / 256 words, so board plus representative payload is 682 words—40.8%
